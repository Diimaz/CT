...
<div class="container">
    ...
    <div class=" form-row " > 
        <div class="form-group col-md-4">
            ...
            <div class="control">
                <input name='nombre' value='<?=old('nombre')?>' class="form-control"   type="text" placeholder="Ej: Melvin Marvin">
            </div>
        ...
        <div class="form-group col-md-4">
            ...
            <div class="control has-icons-left has-icons-right">
                <input name='email' value='<?=old('email')?>' class="form-control" type="" placeholder="email@gmail.com" value="">
